...
public:
  ...
  static void set_source_rgb(const Cairo::RefPtr<Cairo::Context> &cr,
                             std::string hex_color);
  static std::vector<double> hex_to_rgb(std::string hex_val);
  static double hex_to_dec(std::string hex_val);

  static std::string gen_ins_stmt(std::string table_name,
                                  std::vector<std::string> fields,
                                  std::vector<std::string> values);
  static std::string file_to_song_name(std::string file);
  static std::string replace(std::string text, std::string find_value,
  ...
  static std::pair<bool, int> search_vect(std::vector<std::string> vect,
  ...
  template <class T> static std::string to_string(T input) {
