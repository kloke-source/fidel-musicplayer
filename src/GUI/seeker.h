...
private:
  ...
  static void data_validator(std::string text,int *character_num, Gtk::Entry *data_entry_widget);
  static void hours_tenths_handler(const std::string& text,int* character_num);
  static void hours_units_handler(const std::string& text,int* character_num);
  static void minutes_tenths_handler(const std::string& text,int* character_num);
  static void minutes_units_handler(const std::string& text,int* character_num);
  static void seconds_tenths_handler(const std::string& text,int* character_num);
  static void seconds_units_handler(const std::string& text,int* character_num);
};
