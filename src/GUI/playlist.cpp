...
Gtk::ScrolledWindow *playlist_scrolled_window;
Gtk::TreeView *playlist_tree_view;
Glib::RefPtr<Gtk::ListStore> playlist_model;
vector<btree<Glib::ustring>> playlist_info_store;
...
Gtk::ScrolledWindow* Playlist::get_frame()
{
  return playlist_scrolled_window;
}

void Playlist::init_playlist()
  {
	playlist_scrolled_window = new Gtk::ScrolledWindow();
	...
	playlist_scrolled_window->add(*playlist_tree_view);
	playlist_scrolled_window->set_policy(Gtk::POLICY_NEVER, Gtk::POLICY_AUTOMATIC);
