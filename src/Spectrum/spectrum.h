...
public:
  ...
  void set_spect_band_magn(int band, double magn);
...
private:
  ...
  double spect_padding_top =
      .02; // 2% this padding is only applied if a spectrum bar reaches the
           // height of the spectrum frame
